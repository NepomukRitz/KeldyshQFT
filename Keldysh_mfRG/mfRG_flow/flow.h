...
#include "../correlation_functions/state.h"               // state including vertex and self-energy
#include "../perturbation_theory_and_parquet/perturbation_theory.h" // for initialization with SOPT at the beginning of the flow, using sopt_state
#include "../grids/flow_grid.h"     // for flow grid
#include "../ODE_solvers/ODE_solvers.h"         // for ODE solver (Runge Kutta 4)
#include "right_hand_sides.h"    // to compute right hand side of flow equation
#include "../perturbation_theory_and_parquet/parquet_solver.h"      // to compute the parquet solution as alternative starting point of the flow
