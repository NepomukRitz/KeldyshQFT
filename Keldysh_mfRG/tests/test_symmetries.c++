...
void test_symmetries(const double Lambda) {
    ...
    write_state_to_hdf(data_dir + "SOPT.h5", Lambda, 1, state_ini);

    //state_ini.vertex.template symmetry_expand<'a',true>();
    //state_ini.vertex.save_expanded(data_dir + "symmetry_expanded_for_a_left.h5");
    //state_ini.vertex.template symmetry_expand<'a',false>();
    //state_ini.vertex.save_expanded(data_dir + "symmetry_expanded_for_a_right.h5");
    //state_ini.vertex.template symmetry_expand<'t',true>();
    //state_ini.vertex.save_expanded(data_dir + "symmetry_expanded_for_t_left.h5");
    //state_ini.vertex.template symmetry_expand<'t',false>();
    //state_ini.vertex.save_expanded(data_dir + "symmetry_expanded_for_t_right.h5");
