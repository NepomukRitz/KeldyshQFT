...
public:
    ...
    /*
    FPP_Grid& operator=(const FPP_Grid& other){ // Copy assignment
        this->Ns_grid = other.Ns_grid;
        this->specific_points = other.specific_points;
        this->negative_values = other.negative_values;
        this->zero_included = other.zero_included;
        this->grid_types = other.grid_types;
