...
//    State<comp> PT4_13_t_at2 (Lambda);
    ...
    // K1 in PT2
    comp PT2_K1a_0 = PT2_K1a.vertex[0].avertex.K1_valsmooth(input_a, PT2_K1a.vertex[0].tvertex);
    comp PT2_K1p_0 = PT2_K1p.vertex[0].pvertex.K1_valsmooth(input_p, PT2_K1p.vertex[0].pvertex);
    comp PT2_K1t_0 = PT2_K1t.vertex[0].tvertex.K1_valsmooth(input_t, PT2_K1t.vertex[0].avertex);

    // K1 in PT3
    comp PT3_K1a_0 = PT3_K1a.vertex[0].avertex.K1_valsmooth(input_a, PT3_K1a.vertex[0].tvertex);
    comp PT3_K1p_0 = PT3_K1p.vertex[0].pvertex.K1_valsmooth(input_p, PT3_K1p.vertex[0].pvertex);
    comp PT3_K1t_0 = PT3_K1t.vertex[0].tvertex.K1_valsmooth(input_t, PT3_K1t.vertex[0].avertex);
    comp PT3_K1_exact = -(1./2.) * pow(glb_U / (M_PI * (glb_Gamma + Lambda) / 2.), 2);

    // K1 in PT4
    comp PT4_K1a_0_ladder = PT4_31_a_a1.vertex[0].avertex.K1_valsmooth(input_a, PT4_31_a_a1.vertex[0].tvertex);
    comp PT4_K1p_0_ladder = PT4_31_p_p1.vertex[0].pvertex.K1_valsmooth(input_p, PT4_31_p_p1.vertex[0].pvertex);
    comp PT4_K1a_0_nonladder = PT4_13_a_a2.vertex[0].avertex.K1_valsmooth(input_a, PT4_13_a_a2.vertex[0].tvertex);
    comp PT4_K1p_0_nonladder = PT4_13_p_p2.vertex[0].pvertex.K1_valsmooth(input_p, PT4_13_p_p2.vertex[0].pvertex);
    comp PT4_K1t_0_nonladder_a = PT4_13_t_a2.vertex[0].tvertex.K1_valsmooth(input_t, PT4_13_t_a2.vertex[0].avertex);
    comp PT4_K1t_0_nonladder_t = PT4_13_t_t2.vertex[0].tvertex.K1_valsmooth(input_t, PT4_13_t_t2.vertex[0].avertex);
    ...
    for (int iK2=0; iK2<2; ++iK2) {
        ...
        input_t.iK = iK2s[iK2];
        // K2 in PT3
        PT3_K2a_0[iK2] = PT3_K2a.vertex[0].avertex.K2_valsmooth(input_a, PT3_K2a.vertex[0].tvertex);
        PT3_K2p_0[iK2] = PT3_K2p.vertex[0].pvertex.K2_valsmooth(input_p, PT3_K2p.vertex[0].pvertex);
        PT3_K2t_0[iK2] = PT3_K2t.vertex[0].tvertex.K2_valsmooth(input_t, PT3_K2t.vertex[0].avertex);
        // K2 in PT4
        PT4_K2a_0_p1[iK2] = PT4_31_a_p1.vertex[0].avertex.K2_valsmooth(input_a, PT4_31_a_p1.vertex[0].tvertex);
        PT4_K2p_0_a1[iK2] = PT4_31_p_a1.vertex[0].pvertex.K2_valsmooth(input_p, PT4_31_p_a1.vertex[0].pvertex);
        PT4_K2a_0_t1[iK2] = PT4_31_a_t1.vertex[0].avertex.K2_valsmooth(input_a, PT4_31_a_t1.vertex[0].tvertex);
        PT4_K2p_0_t1[iK2] = PT4_31_p_t1.vertex[0].pvertex.K2_valsmooth(input_p, PT4_31_p_t1.vertex[0].pvertex);
        PT4_K2a_0_a2[iK2] = PT4_31_a_a2.vertex[0].avertex.K2_valsmooth(input_a, PT4_31_a_a2.vertex[0].tvertex);
        PT4_K2a_0_p2[iK2] = PT4_31_a_p2.vertex[0].avertex.K2_valsmooth(input_a, PT4_31_a_p2.vertex[0].tvertex);
        PT4_K2a_0_t2[iK2] = PT4_31_a_t2.vertex[0].avertex.K2_valsmooth(input_a, PT4_31_a_t2.vertex[0].tvertex);
        PT4_K2p_0_a2[iK2] = PT4_31_p_a2.vertex[0].pvertex.K2_valsmooth(input_p, PT4_31_p_a2.vertex[0].pvertex);
        PT4_K2p_0_p2[iK2] = PT4_31_p_p2.vertex[0].pvertex.K2_valsmooth(input_p, PT4_31_p_p2.vertex[0].pvertex);
        PT4_K2p_0_t2[iK2] = PT4_31_p_t2.vertex[0].pvertex.K2_valsmooth(input_p, PT4_31_p_t2.vertex[0].pvertex);
        PT4_K2t_0_a2[iK2] = PT4_31_t_a2.vertex[0].tvertex.K2_valsmooth(input_t, PT4_31_t_a2.vertex[0].avertex);
        PT4_K2t_0_t2[iK2] = PT4_31_t_t2.vertex[0].tvertex.K2_valsmooth(input_t, PT4_31_t_t2.vertex[0].avertex);
    }
#endif
...
#if DIAG_CLASS == 3
    PT4_K3a_0 = PT4_22_a_pp.vertex[0].avertex.K3_valsmooth(input_a, PT4_22_a_pp.vertex[0].tvertex);
    PT4_K3p_0 = PT4_22_p_aa.vertex[0].pvertex.K3_valsmooth(input_p, PT4_22_p_aa.vertex[0].pvertex);
    PT4_K3t_0_aa = PT4_22_t_aa.vertex[0].tvertex.K3_valsmooth(input_t, PT4_22_t_aa.vertex[0].avertex);
    PT4_K3t_0_ap = PT4_22_t_ap.vertex[0].tvertex.K3_valsmooth(input_t, PT4_22_t_ap.vertex[0].avertex);
    PT4_K3t_0_pa = PT4_22_t_pa.vertex[0].tvertex.K3_valsmooth(input_t, PT4_22_t_pa.vertex[0].avertex);
#endif
