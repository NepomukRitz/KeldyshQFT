...
void test_PT4(double Lambda, bool write_flag = false) {
    ...
    PT3_K1t.vertex[0].tvertex().K2 = vec<Q> (PT3_K1t.vertex[0].tvertex().K2.size());
#endif
    ...
    PT3_K2t_a.vertex[0].tvertex().K1 = vec<Q> (PT3_K2t_a.vertex[0].tvertex().K1.size());
    ...
    State<Q> PT4_31 (Lambda);
    State<Q> PT4_31_a_a1 (Lambda);
    State<Q> PT4_31_a_p1 (Lambda);
    State<Q> PT4_31_a_t1 (Lambda);
    State<Q> PT4_31_a_a2 (Lambda);
    State<Q> PT4_31_a_p2 (Lambda);
    State<Q> PT4_31_a_t2 (Lambda);
    State<Q> PT4_31_p_a1 (Lambda);
    State<Q> PT4_31_p_p1 (Lambda);
    State<Q> PT4_31_p_t1 (Lambda);
    State<Q> PT4_31_p_a2 (Lambda);
    State<Q> PT4_31_p_p2 (Lambda);
    State<Q> PT4_31_p_t2 (Lambda);
    State<Q> PT4_31_t_a1 (Lambda);
    State<Q> PT4_31_t_p1 (Lambda);
    State<Q> PT4_31_t_t1 (Lambda);
    State<Q> PT4_31_t_a2 (Lambda);
    State<Q> PT4_31_t_p2 (Lambda);
    State<Q> PT4_31_t_t2 (Lambda);

    State<Q> PT4_13 (Lambda);
    State<Q> PT4_13_a_a1 (Lambda);
    State<Q> PT4_13_a_p1 (Lambda);
    State<Q> PT4_13_a_t1 (Lambda);
    State<Q> PT4_13_a_a2 (Lambda);
    State<Q> PT4_13_a_p2 (Lambda);
    State<Q> PT4_13_a_t2 (Lambda);
    State<Q> PT4_13_p_a1 (Lambda);
    State<Q> PT4_13_p_p1 (Lambda);
    State<Q> PT4_13_p_t1 (Lambda);
    State<Q> PT4_13_p_a2 (Lambda);
    State<Q> PT4_13_p_p2 (Lambda);
    State<Q> PT4_13_p_t2 (Lambda);
    State<Q> PT4_13_t_a1 (Lambda);
    State<Q> PT4_13_t_p1 (Lambda);
    State<Q> PT4_13_t_t1 (Lambda);
    State<Q> PT4_13_t_a2 (Lambda);
    State<Q> PT4_13_t_p2 (Lambda);
    State<Q> PT4_13_t_t2 (Lambda);

    State<Q> PT4_22 (Lambda);
    State<Q> PT4_22_a_aa (Lambda);
    State<Q> PT4_22_a_ap (Lambda);
    State<Q> PT4_22_a_pa (Lambda);
    State<Q> PT4_22_a_pp (Lambda);
    State<Q> PT4_22_p_aa (Lambda);
    State<Q> PT4_22_p_ap (Lambda);
    State<Q> PT4_22_p_pa (Lambda);
    State<Q> PT4_22_p_pp (Lambda);
    State<Q> PT4_22_t_aa (Lambda);
    State<Q> PT4_22_t_ap (Lambda);
    State<Q> PT4_22_t_pa (Lambda);
    State<Q> PT4_22_t_pp (Lambda);
    ...
    // K1 in PT2
    Q PT2_K1a_0 = PT2_K1a.vertex[0].avertex().valsmooth<k1>(input_a, PT2_K1a.vertex[0].tvertex());
    Q PT2_K1p_0 = PT2_K1p.vertex[0].pvertex().valsmooth<k1>(input_p, PT2_K1p.vertex[0].pvertex());
    Q PT2_K1t_0 = PT2_K1t.vertex[0].tvertex().valsmooth<k1>(input_t, PT2_K1t.vertex[0].avertex());

    // K1 in PT3
    Q PT3_K1a_0 = PT3_K1a.vertex[0].avertex().valsmooth<k1>(input_a, PT3_K1a.vertex[0].tvertex());
    Q PT3_K1p_0 = PT3_K1p.vertex[0].pvertex().valsmooth<k1>(input_p, PT3_K1p.vertex[0].pvertex());
    Q PT3_K1t_0 = PT3_K1t.vertex[0].tvertex().valsmooth<k1>(input_t, PT3_K1t.vertex[0].avertex());
#ifdef KELDYSH_FORMALISM
    Q PT3_K1_exact = -(1./2.) * pow(glb_U / (M_PI * (glb_Gamma + Lambda) / 2.), 2);
#else
    Q PT3_K1_exact = - glb_U * pow(glb_U / (M_PI * (glb_Gamma + Lambda) / 2.), 2);
#endif

    // K1 in PT4
    Q PT4_K1a_0_ladder = PT4_31_a_a1.vertex[0].avertex().valsmooth<k1>(input_a, PT4_31_a_a1.vertex[0].tvertex());
    Q PT4_K1p_0_ladder = PT4_31_p_p1.vertex[0].pvertex().valsmooth<k1>(input_p, PT4_31_p_p1.vertex[0].pvertex());
    Q PT4_K1a_0_nonladder = PT4_13_a_a2.vertex[0].avertex().valsmooth<k1>(input_a, PT4_13_a_a2.vertex[0].tvertex());
    Q PT4_K1p_0_nonladder = PT4_13_p_p2.vertex[0].pvertex().valsmooth<k1>(input_p, PT4_13_p_p2.vertex[0].pvertex());
    Q PT4_K1t_0_nonladder_a = PT4_13_t_a2.vertex[0].tvertex().valsmooth<k1>(input_t, PT4_13_t_a2.vertex[0].avertex());
    Q PT4_K1t_0_nonladder_t = PT4_13_t_t2.vertex[0].tvertex().valsmooth<k1>(input_t, PT4_13_t_t2.vertex[0].avertex());
    ...
    vec<Q> PT3_K2t_0 (3);
    // K2 in PT4
    vec<Q> PT4_K2a_0_p1 (3);
    vec<Q> PT4_K2p_0_a1 (3);
    vec<Q> PT4_K2a_0_t1 (3);
    vec<Q> PT4_K2p_0_t1 (3);
    vec<Q> PT4_K2a_0_a2 (3);
    vec<Q> PT4_K2a_0_p2 (3);
    vec<Q> PT4_K2a_0_t2 (3);
    vec<Q> PT4_K2p_0_a2 (3);
    vec<Q> PT4_K2p_0_p2 (3);
    vec<Q> PT4_K2p_0_t2 (3);
    vec<Q> PT4_K2t_0_a2 (3);
    vec<Q> PT4_K2t_0_t2 (3);
...
#ifdef KELDYSH_FORMALISM
    Q PT3_K2_exact = -(1./2.) * (2. - M_PI*M_PI/4.) * pow(glb_U / (M_PI * (glb_Gamma + Lambda) / 2.), 2);
#else
    Q PT3_K2_exact = - (2. - M_PI*M_PI/4.) * glb_U * pow(glb_U / (M_PI * (glb_Gamma + Lambda) / 2.), 2);
#endif
    ...
    vec<Q> check_values {PT2_K1a_0 + PT2_K1p_0,
                            PT2_K1t_0,
