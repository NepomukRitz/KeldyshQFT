...
template <typename Q> void selfEnergyFlowCorrections(SelfEnergy<Q>& dPsiSelfEnergy, const Vertex<Q>& dGammatbar_C, const State<Q>& Psi, const Propagator<Q>& G);
...
template <typename Q>
void vertexOneLoopFlow(Vertex<Q>& dPsiVertex, const Vertex<Q>& PsiVertex, const Propagator<Q>& G, const Propagator<Q>& dG){
...
template <typename Q>
auto calculate_dGammaL(Vertex<Q>& dPsiVertex, const Vertex<Q>& PsiVertex, const Propagator<Q>& G) -> Vertex<Q>{
...
template <typename Q>
auto calculate_dGammaR(Vertex<Q>& dPsiVertex, const Vertex<Q>& PsiVertex, const Propagator<Q>& G) -> Vertex<Q>{
...
// TODO: old version -> remove?
//template <typename Q>
//auto calculate_dGammaC_ap(const Vertex<Q>& PsiVertex, const Vertex<Q>& dGammaL, const Propagator<Q>& G) -> Vertex<Q>{
...
//
//template <typename Q>
//auto calculate_dGammaC_t (const Vertex<Q>& PsiVertex, const Vertex<Q>& dGammaL, const Propagator<Q>& G) -> Vertex<Q>{
...
template <typename Q>
void selfEnergyFlowCorrections(SelfEnergy<Q>& dPsiSelfEnergy, const Vertex<Q>& dGammatbar_C, const State<Q>& Psi, const Propagator<Q>& G){
