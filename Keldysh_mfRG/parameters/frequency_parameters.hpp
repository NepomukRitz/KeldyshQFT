...
constexpr int nBOS = 11;
constexpr int nFER = 11 - (KELDYSH_FORMALISM ? 0 : 1);
// Number of frequency points for K2 and K3 classes
constexpr int nBOS2 = 5;//nBOS;
constexpr int nFER2 = 5 - (KELDYSH_FORMALISM or ZERO_TEMP ? 0 : 1);//nFER;
constexpr int nBOS3 = 3; //nBOS;
constexpr int nFER3 = 3 - (KELDYSH_FORMALISM or ZERO_TEMP ? 0 : 1); //nFER;
