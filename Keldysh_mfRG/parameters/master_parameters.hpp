...
const std::vector<double> U_over_pi_NRG {0.05*M_PI, 0.1*M_PI, 0.2*M_PI, 0.25*M_PI, 0.5*M_PI, 0.75*M_PI, 1.*M_PI,
                                         1.2*M_PI, 1.25*M_PI, 1.5*M_PI, 1.75*M_PI, 2.*M_PI, 2.25*M_PI, 2.5*M_PI};
