    ...
    if(w!=0){
        ...
        if(type == 'g'){//regular undifferentiated greensfunction
            ...
            if(reg==1){
                ...
                comp G0 = (1.-exp(-pow(fabs(w)/Lambda,sharp))) * 1./iw; //bare greens function with smoothened cutoff at freq ffreqs[i]
                comp G = 1./( 1./G0 - selfenergy.svalsmooth(w)); //full greens function at ffreqs[i]
            ...
            if(reg==1){
                ...
                comp G0 = (1.-exp(-pow(abs(w)/Lambda,sharp))) * 1./iw; //bare greens function with smoothened cutoff at freq ffreqs[i]
                comp G = 1./( 1./G0 - selfenergy.svalsmooth(w)); //full greens function at ffreqs[i]
