#ifndef XD_FLOW_ZERO_MAG_COMPUTE_RHS_23082017
#define XD_FLOW_ZERO_MAG_COMPUTE_RHS_23082017
...
template<int mode> class XD_ud_compute_rhs{
 	public:
		Numerics &num;
		X_bubble_central_zero_mag<mode> &Bubble_dyn;
		...
		XD_ud_compute_rhs(Numerics &num_in, X_bubble_central_zero_mag<mode> &Bubble_dyn_in, Barevertex &barevertex_in, Vertex<mode> &gamma_in, matrix<matrix<double> > &Bubble_stat_data, matrix<matrix<double> > &Xud_stat_data_in, matrix<matrix<double> > &Duu_stat_data_in, matrix<matrix<double> > &Dud_stat_data_in);
		matrix<syma<complex<double> > > operator()(int xd_freq_ind);
};

template<int mode> XD_ud_compute_rhs<mode>::XD_ud_compute_rhs(Numerics &num_in, X_bubble_central_zero_mag<mode> &Bubble_dyn_in, Barevertex &barevertex_in, Vertex<mode> &gamma_in, matrix<matrix<double> > &Bubble_stat_data_in, matrix<matrix<double> > &Xud_stat_data_in, matrix<matrix<double> > &Duu_stat_data_in, matrix<matrix<double> > &Dud_stat_data_in):num(num_in), Bubble_dyn(Bubble_dyn_in), barevertex(barevertex_in), gamma(gamma_in), Bubble_stat_data(Bubble_stat_data_in), Xud_stat_data(Xud_stat_data_in), Duu_stat_data(Duu_stat_data_in), Dud_stat_data(Dud_stat_data_in){}
