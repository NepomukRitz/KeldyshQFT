PROGRAM=/gpfs/homea/hmu26/hmu261/bin/dsfRG_mpi_with_disorder
DIR_DATA_OUT=/gpfs/work/hmu26/hmu261/DATA/Paid_systematic_test_correct/N15_Disorder_correct/Standard_code
