...
#s_folder="/gpfs/work/hmu26/hmu261/DATA/Paid_systematic_test/N15_Disorder/OMP_standard/"
s_folder="/work/hmu26/hmu261/DATA/Paid_systematic_test_correct/N15_Disorder/OMP_standard/"

paid_order = 4
node_list=[4,8,16,32,64]

#Preload to determine dimensions:
s_file="dsfRG_mpi_with_paid_L0_Lu0_N15_Nff_1500_NfbP_1500_NfbX_1500_num_freq_pre_30000_Vg_1.200000_h_0.000000_mu_0.000000_T_0.100000_U0_0.800000_U1_0.000000_Xi_5.000000_acc_p1.00e-04_acc_x1.00e-04_acc_s1.00e-04_acc_f1.00e-06_pd_order%d_number_of_nodes_%d.mat" % (paid_order,node_list[0])
s=s_folder + s_file
...
for node_ind in range(len(node_list)):
	...
	s_file="dsfRG_mpi_with_paid_L0_Lu0_N15_Nff_1500_NfbP_1500_NfbX_1500_num_freq_pre_30000_Vg_1.200000_h_0.000000_mu_0.000000_T_0.100000_U0_0.800000_U1_0.000000_Xi_5.000000_acc_p1.00e-04_acc_x1.00e-04_acc_s1.00e-04_acc_f1.00e-06_pd_order%d_number_of_nodes_%d.mat" % (paid_order,node_number)
	s=s_folder + s_file
...
for node_ind in range(len(node_list)):
	...
	s_folder="/work/hmu26/hmu261/DATA/Paid_systematic_test_correct/N15_Disorder/Standard_code/"
	s_file="dsfRG_mpi_L0_Lu0_N15_Nff_1500_NfbP_1500_NfbX_1500_num_freq_pre_30000_Vg_1.200000_h_0.000000_mu_0.000000_T_0.100000_U0_0.800000_U1_0.000000_Xi_5.000000_Lambda_ini_99999.500001_Lambda_fin_0.000000_number_of_nodes_%d.mat" % (node_number)
	s=s_folder + s_file
	gamma_data_short_str = ctn.load_as_np(s,"gamma_data_short_str")
...
#		s_folder="/work/hmu26/hmu261/DATA/Paid_systematic_test_correct/N15_Disorder/OMP_inside/"
#		s_file="dsfRG_mpi_with_paid_L0_Lu0_N15_Nff_1500_NfbP_1500_NfbX_1500_num_freq_pre_30000_Vg_1.200000_h_0.000000_mu_0.000000_T_0.100000_U0_0.800000_U1_0.000000_Xi_5.000000_acc_p1.00e-04_acc_x1.00e-04_acc_s1.00e-04_acc_f1.00e-06_pd_order%d_number_of_nodes_%d.mat" % (paid_order,node_number)
#		s=s_folder + s_file
#		gamma_data_short_str = ctn.load_as_np(s,"gamma_data_short_str")
