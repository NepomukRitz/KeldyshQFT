...
int main(){
	...
	{
		Integrand_self_same_spin<mode> integrand_same(external_freq, spin, phy, num, pre, sub, measure_flow, gamma);	
		Integrand_self_opposite_spin<mode> integrand_oppo(external_freq, spin, phy, num, pre, sub, measure_flow, gamma);	
		double internal=0.6;
