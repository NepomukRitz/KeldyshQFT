...
associated_energies_int_T_tilde=empty([len(T_list),Nges])
for ind_T in range(len(T_list)):
 	print(ind_T)
 	T = T_list[ind_T]
	foldername="/naslx/projects/uh3o1/ri26yad/DATA/Density_matrix_eigenvalues/Without_leads_tmp/"
	filename="density_matrix_tmp_N8_Vg2.000000_mu0.000000_T0.000000_U00.800000_num_freq_pre600000.mat" 
	...
	original_data_filename="Chain_disorder_central_build_N16_Vg2.000000_Vsg0.000000_width0_mu0.000000000_T%.9f_h0.000000000_U 0.800000_seed5.mat" % (T_list[ind_T])
...
associated_energies_non_int_T=empty([len(T_list),Nges])
for ind_T in range(len(T_list)):
 	T = T_list[ind_T]
	print(ind_T)
	foldername="/naslx/projects/uh3o1/ri26yad/DATA/Density_matrix_eigenvalues/Without_leads_tmp/"
...
savename='density_matrix_int_without_leads_and_full_energies_Vg%d.pdf' % (Vg)
