//
// Created by Sa.Aguirre on 6/21/19.
//

#ifndef KELDYSH_SELFENERGY_SOPT_PROPAGATOR_H
#define KELDYSH_SELFENERGY_SOPT_PROPAGATOR_H
...
//    }
    ...
    {
        for(int i=0; i<vec.size(); i++)
            vec[i] = vec[i].real() - 1.i*vec[i].imag();
        return *this;
    }
};


#endif //KELDYSH_SELFENERGY_SOPT_PROPAGATOR_H
