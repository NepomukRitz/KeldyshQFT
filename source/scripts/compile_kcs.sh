#!/bin/bash
#  environment variable KELDYSH_MFRG needs to point to the "source" directory of the repository:
#  in ~/.bashrc:
#  export KELDYSH_MFRG="/dss/dsskcsfs01/pn34vu/pn34vu-dss-0000/<lrz-ID>/mfrg/source"
