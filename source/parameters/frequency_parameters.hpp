...
constexpr int nBOS3 = 5;                                                       ///< Number of bosonic frequency points for the K3 vertex class.
constexpr int nFER3 = 5 - (KELDYSH_FORMALISM or ZERO_TEMP ? 0 : 1);            ///< Number of fermionic frequency points for the K3 vertex class.
