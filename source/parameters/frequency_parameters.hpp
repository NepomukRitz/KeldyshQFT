...
constexpr int nBOS = 51;                                                       ///< Number of bosonic frequency points for the K1 vertex class.
constexpr int nFER = 51 - (KELDYSH_FORMALISM ? 0 : 1);                         ///< Number of fermionic frequency points for the self-energy.
// Number of frequency points for K2 and K3 classes
constexpr int nBOS2 = 31;                                                      ///< Number of bosonic frequency points for the K2 and K2' vertex classes.
constexpr int nFER2 = 31 - (KELDYSH_FORMALISM or ZERO_TEMP ? 0 : 1);           ///< Number of fermionic frequency points for the K2 and K2' vertex classes.
