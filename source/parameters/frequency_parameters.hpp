...
constexpr int nBOS = 801;                                                       ///< Number of bosonic frequency points for the K1 vertex class.
constexpr int nFER = 801 - (KELDYSH_FORMALISM ? 0 : 1);                         ///< Number of fermionic frequency points for the self-energy.
// Number of frequency points for K2 and K3 classes
constexpr int nBOS2 = 401;                                                      ///< Number of bosonic frequency points for the K2 and K2' vertex classes.
constexpr int nFER2 = 401 - (KELDYSH_FORMALISM or ZERO_TEMP ? 0 : 1);           ///< Number of fermionic frequency points for the K2 and K2' vertex classes.
constexpr int nBOS3 = 101;                                                       ///< Number of bosonic frequency points for the K3 vertex class.
constexpr int nFER3 = 101 - (KELDYSH_FORMALISM or ZERO_TEMP ? 0 : 1);            ///< Number of fermionic frequency points for the K3 vertex class.
