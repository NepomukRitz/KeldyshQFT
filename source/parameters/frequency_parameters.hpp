...
constexpr int nBOS3 = 201;                                                       ///< Number of bosonic frequency points for the K3 vertex class.
constexpr int nFER3 = 201 - (KELDYSH_FORMALISM or ZERO_TEMP ? 0 : 1);            ///< Number of fermionic frequency points for the K3 vertex class.
