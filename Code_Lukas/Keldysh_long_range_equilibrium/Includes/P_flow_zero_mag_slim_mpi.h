#ifndef P_FLOW_ZERO_MAG_SLIM_MPI_23082017
#define P_FLOW_ZERO_MAG_SLIM_MPI_23082017
...
#pragma omp parallel for
	...
	int dim_scattered = (NfbP_per_proc_simple+1)*dim_syma;
	int dim_full = (NfbP_per_proc_simple+1)*nprocs*dim_syma;
