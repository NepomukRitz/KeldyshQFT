...
PROGRAM=/home/hpc/uh3o1/ri26yad/bin/ex_dsfRG_production_mpp3
...
DIR_DATA_OUT=/gpfs/scratch/uh3o1/ri26yad/Ex_DATA_lrz_scratch/QPC_zero_tmp_lrz_no_lr_extrapolation_with_additional_freq_in_px/
DIR_LOG=/gpfs/scratch/uh3o1/ri26yad/Ex_DATA_lrz_scratch/QPC_zero_tmp_lrz_no_lr_extrapolation_with_additional_freq_in_px/AA_LOG
mkdir -p $DIR_LOG 
