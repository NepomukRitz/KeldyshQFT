...
paid_order_list=[2,4,8,16]
#paid_order_list=[2,4]


#Preload to determine dimensions:
s_file="dsfRG_mpi_with_paid_L0_Lu0_N15_Nff_1500_NfbP_1500_NfbX_1500_num_freq_pre_30000_Vg_1.200000_h_0.000000_mu_0.000000_T_0.100000_U0_0.800000_U1_0.000000_Xi_5.000000_acc_p1.00e-04_acc_x1.00e-04_acc_s1.00e-04_acc_f1.00e-06_pd_order%d_number_of_nodes_8.mat" % (paid_order_list[0])
s=s_folder + s_file
...
for paid_order_ind in range(len(paid_order_list)):
	...
	s_file="dsfRG_mpi_with_paid_L0_Lu0_N15_Nff_1500_NfbP_1500_NfbX_1500_num_freq_pre_30000_Vg_1.200000_h_0.000000_mu_0.000000_T_0.100000_U0_0.800000_U1_0.000000_Xi_5.000000_acc_p1.00e-04_acc_x1.00e-04_acc_s1.00e-04_acc_f1.00e-06_pd_order%d_number_of_nodes_8.mat" % (paid_order)
	s=s_folder + s_file
...
axis.text(8,7500,r'Disorder, 31 sites, $8$ Nodes')
plt.savefig('disorder_omp_standard_paid_order_scaling.pdf', format = 'pdf')
plt.show()
