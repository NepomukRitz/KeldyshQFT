...
for ind_T in range(len(T_list)):
	...
	filename="density_matrix_tmp_N8_Vg0.500000_mu0.000000_T0.000000_U00.800000_num_freq_pre600000.mat" 
	...
	original_data_filename="Chain_disorder_central_build_N16_Vg0.500000_Vsg0.000000_width0_mu0.000000000_T%.9f_h0.000000000_U 0.800000_seed5.mat" % (T_list[ind_T])
