...
int main(int argc, char *argv[]){
...

	{
		...
		matrix<syma<complex<double> > > A_same_up = ex_compute_dyn_self(num.wf, integrator_same_up); 
		matrix<syma<complex<double> > > A_opposite_up = ex_compute_dyn_self(num.wf, integrator_opposite_up); 
		matrix<syma<complex<double> > > A_same_down = ex_compute_dyn_self(num.wf, integrator_same_down); 
		matrix<syma<complex<double> > > A_opposite_down = ex_compute_dyn_self(num.wf, integrator_opposite_down); 
		cout<<"A_opposite_up="<<endl;
		cout<<A_opposite_up<<endl;
	}
